    ...
    <div class="wrapper">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    <td colspan="2">
                        <input type="submit" name="submit" value="Add Locaton" class="btn-secondary">
                    </td>
                </tr>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name != "")
                    {
                        ...
                        //Rename the Image
                        $image_name = "Resort_Location_".rand(000, 999).'.'.$ext; // e.g. Food_Category_834.jpg
                ...
                $sql = "INSERT INTO location_table SET
                    title='$title',
